...
public:
  MegaCoreMCCodeEmitter(const MCInstrInfo &, MCContext &ctx) : Ctx(ctx) {}
  MegaCoreMCCodeEmitter(const MegaCoreMCCodeEmitter &) = delete;
  MegaCoreMCCodeEmitter &operator=(const MegaCoreMCCodeEmitter &) = delete;
...
void MegaCoreMCCodeEmitter::encodeInstruction(const MCInst &MI,
...
unsigned MegaCoreMCCodeEmitter::getMachineOpValue(const MCInst &MI,
                                             const MCOperand &MO,
                                             SmallVectorImpl<MCFixup> &Fixups,
                                             const MCSubtargetInfo &STI) const {
  if (MO.isReg())
...
unsigned MegaCoreMCCodeEmitter::getSImm16OpValue(const MCInst &MI, unsigned OpNo,
                                            SmallVectorImpl<MCFixup> &Fixups,
                                            const MCSubtargetInfo &STI) const {
...
#include "MegaCoreGenMCCodeEmitter.inc"

MCCodeEmitter *llvm::createMegaCoreMCCodeEmitter(const MCInstrInfo &MCII,
                                            MCContext &Ctx) {
